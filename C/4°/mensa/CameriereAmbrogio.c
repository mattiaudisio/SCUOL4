...
int main(){
  ...
  sem_id = semget(sem_chiave, 3, IPC_CREAT|0666);         //creo il relativi semafori
  ...
  /* inizializzazione del puntatore alla shared memory */
	...
	carrelli[2]=5; //terzo carrello, inizialmente ha 5 ripiani liberi
	carrelli[3]=1; //mensa aperta. Una volta disposti i carrelli, Ambrogio apre la mensa. 

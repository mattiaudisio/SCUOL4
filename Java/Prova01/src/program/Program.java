...
//		System.out.println("Mail di p3 is " + p3.getMail());				// undefined
		...
		System.out.println("f3 ha " + f3.getEta() + " anni [DOPO la variazione]"); // è 14 perchè ho fatto solo la
																					// variazione nel main
		System.out.println("f3 is " + f3.getCognome() + " anni [DOPO la variazione]"); // è De Paperi perchè ho fatto

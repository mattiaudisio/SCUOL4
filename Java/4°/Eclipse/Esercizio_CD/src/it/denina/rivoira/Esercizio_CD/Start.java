package it.denina.rivoira.Esercizio_CD;
...
public class Start {
	public static void main(String[] args){
		...
		System.out.println("Album "+cd1.getTitolo()+" è dei "+cd1.getAutore()+", ha "+traccia1+" e dura "+durata1+"secondi");
		System.out.println("Album "+cd2.getTitolo()+" è dei "+cd2.getAutore()+", ha "+traccia2+" e dura "+durata2+"secondi");
